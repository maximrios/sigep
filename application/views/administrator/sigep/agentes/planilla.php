<?php
	...
	$ci->pdf->Cell(45, 7, 'Agrup.:', 1, 0);
	$ci->pdf->Cell(45, 7, 'Sub Grupo:', 1, 0);
	$ci->pdf->Cell(70, 7, 'Función Jerarq. Si.Ge.P.:', 1, 0);
	$ci->pdf->Cell(35, 7, 'Antiguedad al 31/12/12', 'LTB', 0, 'C', FALSE);
	$ci->pdf->Cell(25, 7, 'Años', 'TB', 0, 'C', FALSE);
	$ci->pdf->Cell(25, 7, 'Meses', 'TB', 0, 'C', FALSE);
	$ci->pdf->Cell(25, 7, 'Dias', 'TBR', 1, 'C', FALSE);
	...
	$ci->pdf->SetFont('helvetica', 'B', 10);
	$ci->pdf->Cell(70, 5, 'DOMICILIO', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(40, 5, 'Tel / Cel', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(40, 5, 'FECHA INGRESO', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(120, 5, 'TITULO OBTENIDO', 1, 1, 'C', FALSE);
	$ci->pdf->SetFont('helvetica', '', 10);
	$ci->pdf->MultiCell(70, 10, $agente['domicilioPersona'], 1, 'C', FALSE, 0, '', '', TRUE, 0, FALSE, TRUE, 10, 'M');
	...
	$ci->pdf->MultiCell(120, 10, 'asd', 1, 'C', FALSE, 1, '', '', TRUE, 0, FALSE, TRUE, 10, 'M');
	$ci->pdf->Ln(-5);
	$ci->pdf->Cell(70, 5, '', 0, 0, 'C', FALSE);
	$ci->pdf->Cell(40, 5, $agente['celularPersona'], 1, 0, 'C', FALSE);
	$ci->pdf->Cell(40, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(120, 5, '', 0, 1, 'C', FALSE);
	...
	//$ci->pdf->Cell(10, 5, 'CANT', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(10, 5, 'INJUS', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(10, 5, 'JUST', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(15, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(17, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(17, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(17, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(17, 5, '', 1, 0, 'C', FALSE);
	$ci->pdf->Cell(35, 5, 'OBSERVACIONES', 1, 1, 'C', FALSE);
	$ci->pdf->Cell(10, 5, 'M', 1, 0, 'C', FALSE);
	...
	foreach ($meses as $mes) {
		$i++;
		$ci->pdf->MultiCell(10, 6, $mes, 'LTR', 'C', FALSE, 0, '', '', TRUE, 0, FALSE, TRUE, 6, 'M');
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		...
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(10, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(10, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(10, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(15, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(17, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(17, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(17, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(17, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(35, 3, '', 1, 1, 'C', FALSE);
		$ci->pdf->Cell(10, 3, '', 'LBR', 0, 'C', FALSE);	
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
		$ci->pdf->Cell(7, 3, '', 1, 0, 'C', FALSE);
