...
?>
	...
	<div class="accionesd">
		...
		<form id="frmBuscador" name="frmBuscador" action="administrator/licencias/listadoSolicitudes" method="post" target="contenido-abm">
			<input type="text" id="txtvcBuscar" name="vcBuscar" value="<?=$txtvcBuscar?>" placeholder="Ingrese un Criterio de Búsqueda" <?=classRegValidation('vcBuscar', 'custom[onlySearch]')?> />
				...
				<?php if($txtvcBuscar): ?>
            		<a href="administrator/licencias/listadoPersonal" target="contenido-abm" class="btn-accion limpiar btn-reset limpiarBusqueda" title="Limpiar Búsqueda">&nbsp;</a>
            	<?php endif; ?>				
