<?php
	...
	$ci->pdf->Cell(50, 7, 'Tipo de Actuación', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, '', 1, 1, 'L', FALSE);
	$ci->pdf->Cell(50, 7, 'Número', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, $actuacion['codigoActuacion'], 1, 1, 'L', FALSE);
	$ci->pdf->Cell(50, 7, 'Número de Referencia SICE', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, $actuacion['referenciaActuacion'], 1, 1, 'L', FALSE);
	$ci->pdf->Cell(50, 7, 'Fecha de Creación', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, '', 1, 1, 'L', FALSE);
	$ci->pdf->Cell(50, 7, 'Fecha de Recepción', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, '', 1, 1, 'L', FALSE);
	$ci->pdf->Cell(50, 7, 'Período', 1, 0, 'L', FALSE);
	$ci->pdf->Cell(140, 7, '', 1, 1, 'L', FALSE);
