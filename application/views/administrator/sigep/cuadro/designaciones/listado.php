...
$vcNombreList = (!empty($vcNombreList))? $vcNombreList: 'Designaciones';
	...
	<div class="box-layout-50-rt"> 
  		<div class="toolbar-rgt-sb">
			...
			<div class="toolbar-rgt-sb-izq">
				<a href="cuadro/designaciones/formulario" id="btn-nuevo" class="button agregar btn-accion">Agregar Nuevo</a>
				<div class="clearfloat">&nbsp;</div>
			</div>
	</div>
		</div>
