		...
		<fieldset>
			<div class="fila">
		        <label for="inIdRol">Nombre del Rol</label>
		       	<input type="text" name="vcRolNombre" id="vcRolNombre" value="<?= $Reg['vcRolNombre']; ?>" style="width: 350px;"/>
		    </div>
		    <div class="clearfloat">&nbsp;</div>
			<div class="fila">
		        <label for="tsFechaInicio">Fecha de Publicaci&oacute;n:</label>
		       	<input type="text" name="tsFechaInicio" id="tsFechaInicio" value="<?= $Reg['tsFechaInicio']; ?>" />
		    </div>
		    <div class="fila">
		        <label for="tsFechaCaducidad">Fecha de Caducidad:</label>
		       	<input type="text" name="tsFechaCaducidad" id="tsFechaCaducidad" value="<?= $Reg['tsFechaCaducidad']; ?>" />
		    </div>
		    <div class="clearfloat">&nbsp;</div>
		    <div class="fila">
		        <label for="vcNovTitulo">T&iacute;tulo:</label>
		       	<textarea name="vcNovTitulo" id="vcNovTitulo" style="width: 450px; height: 18px; resize: none;"><?= $Reg['vcNovTitulo']; ?></textarea>
		    </div>
		    <div class="clearfloat">&nbsp;</div>  	
		   	<div class="fila">
		        <label for="vcNovResumen">Resúmen:</label>
		        <textarea name="vcNovResumen" id="vcNovResumen" style="width: 450px; height: 150px; resize: none;"><?= $Reg['vcNovResumen']; ?></textarea>
		    </div>
	        <div class="clearfloat">&nbsp;</div>
		   	<div class="fila">
		        <label for="vcNovDescripcion">Contenido:</label>
		        <textarea name="vcNovDescripcion" id="vcNovDescripcion" style="width: 450px; height: 150px; resize: none;"><?= $Reg['vcNovDescripcion']; ?></textarea>
		    </div>
	        <div class="clearfloat">&nbsp;</div>
		</fieldset>
		<br/>
		<div class="buttons">
			<input type="submit" class="button guardar btn-accion<?= (empty($Reg['inIdNovedadesRol'])?' btn-reset':''); ?>" value="Eliminar"/>
