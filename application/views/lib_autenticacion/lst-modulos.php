...
$vcNombreList = (!empty($vcNombreList))? $vcNombreList: 'Modulos';
...
<div class="box-layout-50-rt">
	<div class="toolbar-rgt-sb">
  	<div class="toolbar-rgt-sb-der">
  		<div class="forms">
  			<form id="frmBuscador" name="frmBuscador" action="autenticacion/modulos/listado" method="post" target="contenido-abm">
  				<div class="fila">
                    ...
                    <?php if($txtvcBuscar): ?>
                    <a href="autenticacion/modulos/listado" target="contenido-abm" class="btn-accion limpiar btn-reset limpiarBusqueda" title="Limpiar Búsqueda">&nbsp;</a>
                    <?php endif; ?>
  	...
  	<div class="toolbar-rgt-sb-izq">
  		<a href="autenticacion/modulos/formulario" id="btn-nuevo" class="button agregar btn-accion">Agregar Nuevo</a>
  	</div>
		<div class="clearfloat">&nbsp;</div>
	</div>
</div>
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $(".container-gridview tbody tr td:first").html('');
	});
</script>