...
$vcNombreFrm = (!empty($vcNombreFrm))? $vcNombreFrm: 'PIN (N&uacute;mero de Identificaci&oacute;n Personal)';
...
<section class="box-normal-100">
	...
	<form id="<?= $vcFormName; ?>" name="<?= $vcFormName; ?>" action="<?= $vcFrmAction; ?>" method="post" target="contenido-edit">
		<fieldset>
		    <div class="fila">
		        <label for="vcPIN">Ingrese su PIN anterior:</label>
		       	<input type="password" name="vcPIN" id="vcPIN" <?=classRegValidation('vcPIN','','',$vcFrmAction)?> style="width: 250px;"/>
		    </div>
		    <div class="clearfloat">&nbsp;</div>
		    <div class="fila">
		        <label for="vcPINNuevo">Su nuevo PIN:</label>
		       	<input type="password" name="vcPINNuevo" id="vcPINNuevo" <?=classRegValidation('vcPINNuevo','','',$vcFrmAction)?> style="width: 250px;"/>
		    </div>
		    <div class="fila">
		        <label for="vcPINNuevo2">Repita su nuevo PIN:</label>
		       	<input type="password" name="vcPINNuevo2" id="vcPINNuevo2" <?=classRegValidation('vcPINNuevo','','',$vcFrmAction)?> style="width: 250px;"/>
		    </div>		    
		    <div class="clearfloat">&nbsp;</div> 	
		   	<div class="fila">
