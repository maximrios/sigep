 ...
 * 
 */
class Cuadrocargosagentes_model extends CI_Model {
    ...
    public function numRegs($vcBuscar) {
        $sql = 'SELECT count(idCuadroCargo) AS inCant FROM sigep_view_cuadrocargosagentes WHERE lower(denominacionCargo) LIKE ? ;';
