 ...
 */
class Localizacion extends Ext_AutController
{
	private $_modulo;
	private $_ruta;
	...
	{
		parent::__construct();
		$this->load->model($this->db->dbdriver.'/sistema/localizacion_model','localizacion_model');
	...
	{
		echo json_encode($this->localizacion_model->ObtPaises(false));                
	}
