...
class Cuadrocargosagentes extends Ext_crud_controller {
    function __construct() {
        ...
        $this->_aReglas = array(
            ...
            array(
                'field' => 'idInstrumentoLegalCuadroCargoAgente',
                'label' => 'Instrumento de designacion',
                'rules' => 'trim|xss_clean|required'
            ),
            array(
                'field' => 'idEscalafon',
            ...
            array(
                'field' => 'vigenteCuadroCargoAgente',
                'label' => 'Vigencia',
                'rules' => 'trim|xss_clean'
            ),
        );
    ...
    protected function _inicReg($boIsPostBack=false) {
        $this->_reg = array(
            ...
            , 'idInstrumentoLegalCuadroCargoAgente' => null
            , 'idCuadroCargo' => null
        ...
        if ($inId != 0 && !$boIsPostBack) {
            ...
            $this->_reg = array(
                ...
                , 'idInstrumentoLegalCuadroCargoAgente' => set_value('idInstrumentoLegalCuadroCargoAgente')
                , 'idCuadroCargo' => $inId
                ...
                , 'idSituacionRevista' => set_value('idSituacionRevista')
                ...
                , 'vigenteCuadroCargoAgente' => set_value('vigenteCuadroCargoAgente')
            );
        }
        return $this->_reg;
    }
    ...
    public function listado($idNoticia = 0) {
        ...
        $editar = '<a href="administrator/cuadrocargosagentes/formulario/{idCuadroCargo}" title="Editar el estado del cargo Orden N° {ordenCuadroCargo} - {denominacionCargo}" class="btn-accion" rel="{\'idCuadroCargo\': {idCuadroCargo}}"><span class="glyphicon glyphicon-pencil"></span></a>';
    ...
    public function formulario() {
        ...
        $aData['vcFrmAction'] = 'administrator/cuadrocargosagentes/guardar';
        $aData['vcMsjSrv'] = $this->_aEstadoOper['message'];
        $aData['vcAccion'] = ($this->_reg['idCuadroCargo'] > 0) ? 'Modificar' : 'Agregar';
        $aData['agentes'] = $this->agente->dropdownAgentes();
        ...
        $aData['situaciones'] = $this->agente->dropdownSituacionesRevistas();
        ...
        if ($this->_validarReglas()) {
            ...
            $this->_aEstadoOper['status'] = $this->cuadrocargoagente->guardar(
                    array(
                        ...
                        , $this->_reg['idInstrumentoLegalCuadroCargoAgente']
                        , $this->_reg['observacionesCuadroCargoAgente']
                        , $this->_reg['perteneceCuadroCargoAgente']
                        , $this->_reg['vigenteCuadroCargoAgente']
                    )
            );
